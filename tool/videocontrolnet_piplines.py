        ...
        with self.progress_bar(total=num_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if uncond_embeddings is not None:
                    if multi:
                        text_embeddings[:video_length] = uncond_embeddings[i]
                    else:
                        text_embeddings[0] = uncond_embeddings[i]
                ...
                if eta > 0 :
                    ...
                    latents = self.scheduler.step(noise_pred, t, latents, eta = eta, variance_noise = noise).prev_sample
                else :
